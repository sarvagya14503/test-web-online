var $ = jQuery,
  ...
  dsnGrid = {
      ...
      return (
        ...
        e
          ...
          .on("mousemove", function (o) {
            if (
              void 0 !== t.dataActive &&
              jQuery(this).find(e).hasClass(t.dataActive)
            )
              return !1;
    ...
    scaleIt: function (e, n, t) {
      ...
      var i, a, s;
      (s = this.getUndefinedVal(t.plus, 0)),
        (i = this.getUndefinedVal(t.position, !1));
      var r = n.offset();
      (a = void 0 === r || body.hasClass("dsn-effect-scroll") ? 0 : r.top),
        i && (a -= o);
    ...
    scrollerIt: function (e, n, t) {
      ...
      var o,
        ...
        a,
        s = e.scrollTop();
      (a = this.getUndefinedVal(t.duration, 0)),
        (i = this.getUndefinedVal(t.plus, 0));
      var r = n.offset();
    ...
    setPositionMoveSection: function (e, n, t) {
      if (void 0 !== e) {
        var o = e.offset(),
          i = void 0 === o ? 0 : o.top;
        (n = dsnGrid.getUndefinedVal(n, 2)),
          (t = dsnGrid.getUndefinedVal(t, 0));
        var a = (e.innerHeight() + i + t) / 2;
        e.css({ marginBottom: (a / n) * -1 });
      }
    },
    scrollTop: function (e, n, t, o) {
      (n = dsnGrid.getUndefinedVal(n, 500)),
        (t = dsnGrid.getUndefinedVal(t, 0));
      var i = 0;
      "number" == typeof e
        ? (i = e)
        : (e instanceof jQuery == !1 && (e = jQuery(e)),
          void 0 !== (i = e.offset()) && (i = i.top)),
        jQuery("html, body").animate({ scrollTop: i + t }, n, o);
    },
    ...
    mouseMove: function (e, n, t) {
      ...
      var o = jQuery("body");
      if (
        dsnGrid.getUndefinedVal(o.data("dsn-mousemove"), !1) &&
        void 0 !== e &&
        !(e.length <= 0) &&
        null !== e
      ) {
        o.addClass("dsn-mousemove"),
          e instanceof jQuery == !1 && (e = jQuery(e));
        var i = e,
          a = !1;
        o.on("mousemove", function (e) {
          TweenLite.to(i, 0.5, {
            left: e.pageX,
            top: e.pageY,
          }) /*i.css({left:e.pageX,top:e.pageY})*/,
            void 0 !== n &&
              void 0 !== n.onUpdate &&
              n.onUpdate(e, e.pageX, e.pageY, i),
            void 0 !== n &&
              void 0 !== n.onComplete &&
              ((a = !0),
    ...
    convertTextLine: function (e, n) {
      ...
      for (var i = 0; i < t.length; i++)
        0 === i && (o += '<div class="dsn-word-wrapper">'),
          " " !== t.charAt(i)
            ? (o +=
                '<span class="dsn-chars-wrapper">' + t.charAt(i) + "</span>")
            : (o += "</div>" + t.charAt(i) + '<div class="dsn-word-wrapper">');
      (o += "</div>"), n.append(o);
    },
        ...
        if (o[a].length > 0) {
          if (((i += '<span class="dsn-wrapper">'), t)) {
            ...
            for (var s = 0; s < o[a].length; s++)
              i +=
                '<span class="dsn-chars-wrapper">' + o[a].charAt(s) + "</span>";
            i += "</span>";
    ...
    embedVideo: function (e) {
      jQuery("[data-dsn-video]").each(function (e) {
        ...
        n.on("click", function () {
          n.addClass("dsn-video"),
            n.html('<div class="dsn-iframe-player">' + t + "</div>"),
            dsnGrid.scrollTop(n, 1600, -100);
        });
      });
    },
    ...
    parallaxMoveElemnt: function (e, n, t, o, i) {
      ...
      if (
        (void 0 !== e.target &&
          ((a = e.target), (s = void 0 !== e.element ? e.element : e.target)),
        !(s.length <= 0))
      ) {
        (t = void 0 === t ? 0.5 : parseFloat(t)),
          (n = void 0 === n ? 20 : parseFloat(n)),
          (i = void 0 !== i && i);
        ...
        a.append(r),
          ...
          a
            ...
            .on("mousemove", function (e) {
              dsnGrid.parallaxIt(e, s, n),
                dsnGrid.parallaxIt(e, r, 2 * n),
    ...
    parallaxMoveElemntCir: function (e, n, t, o, i) {
      ...
      a.html(""),
        ...
        a
          .on("mouseleave", function (e) {
            TweenMax.to(a, t, { scale: 1 }),
              TweenMax.to(l, 0.3, { scale: 1, x: 0, y: 0 }),
              TweenMax.to(d, t, { scale: 1, x: 0, y: 0 });
          })
          .on("mouseenter", function (e) {
            TweenMax.to(a, t, { transformOrigin: "0 0", scale: 1 }),
              TweenMax.to(d, t, { scale: 1.2 });
          })
          .on("mousemove", function (e) {
    ...
    animateText: function (e, n, t, o) {
      ...
      e.getListener(function (e) {
        (s = void 0 === e.offset ? wind.scrollTop() : 0),
          r && clearTimeout(r),
          (r = setTimeout(i, 10));
      });
    },
    imageLoad: function () {
      ...
      e.each(function () {
        $(this).append(
          '<div class="wait-loader"><div class="loader-inner"><div class="loader-circle"><div class="loader-layer"></div></div></div></div>'
        );
      });
      e.imagesLoaded({ background: ".dsn-img-org" }).progress(function (e, n) {
        let t = $(n.element).parents('[data-dsn-loader="div"]');
        t.length > 0 &&
          (t.addClass("dsn-img-loader-done dsn-animate"),
          t.attr("data-dsn-loader", "divFinshed"));
      });
    },
      ...
      e.isScroller(!0) && (i = e.getScrollbar()),
        e.getListener(function (e) {
          ...
          void 0 === e.offset
            ? (t = wind.scrollTop())
            : ((t = e.offset.y),
              (o = $(document).height() - i.getSize().content.height + 100)),
            t > 70
              ? (TweenMax.to(n, 1, { ease: Back.easeOut.config(4), right: 60 }),
                n
                  .find(".dsn-progress-path")
                  .css(
                    "stroke-dashoffset",
                    300 - Math.round((300 * t) / o) + "%"
                  ))
